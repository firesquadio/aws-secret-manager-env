...
/* harmony import */ var _aws_sdk_client_secrets_manager__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(9600);
/* harmony import */ var _aws_sdk_client_secrets_manager__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__nccwpck_require__.n(_aws_sdk_client_secrets_manager__WEBPACK_IMPORTED_MODULE_1__);


// Create Secrets Manager Client
const client = new _aws_sdk_client_secrets_manager__WEBPACK_IMPORTED_MODULE_1__.SecretsManagerClient({});
// Read Inputs
const secret = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('secret', { required: true });
const json = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getBooleanInput('json', { required: false, });
const name = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('name', { required: !json });
// Create Command
const cmd = new _aws_sdk_client_secrets_manager__WEBPACK_IMPORTED_MODULE_1__.GetSecretValueCommand({ SecretId: secret });
const PullFromSecretsManager = async () => {
    try {
        ...
        _actions_core__WEBPACK_IMPORTED_MODULE_0__.setFailed(`Failed to get secret ${secret} with error ${err}`);
        throw err;
    }
};
const PopulateToEnv = async (secretValue) => {
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.startGroup('Populate to Environment');
    if (json) {
        _actions_core__WEBPACK_IMPORTED_MODULE_0__.startGroup('Parse JSON secret');
        try {
            ...
            _actions_core__WEBPACK_IMPORTED_MODULE_0__.setFailed(`Failed to read secret ${secret} as JSON.`);
            throw err;
        }
        finally {
    ...
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.exportVariable(name, secretValue);
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.setSecret(name);
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.endGroup();
    return;
};
